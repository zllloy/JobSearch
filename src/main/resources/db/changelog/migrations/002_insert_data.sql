...
-- Заполнение таблицы response (отклики)
INSERT INTO response (vacancy_id, resume_id, responded_At)
VALUES (1, 1, '2024-03-11 14:00:00'),
       (2, 2, '2024-03-06 09:30:00'),
       (3, 3, '2024-02-02 11:10:00');